...
namespace UnityEngine.InputSystem.Editor
{
    ...
    //internal class DualSenseManagerEditor : UnityEditor.Editor
    //{
    ...
    //        Join behavior
    //        var joinBehaviorProperty = serializedObject.FindProperty(nameof(DualSenseManager.playerJoin));
    //        EditorGUILayout.PropertyField(joinBehaviorProperty);

    //        switch (joinBehaviorProperty)
    //        {
    //            case }


    //        if ((PlayerJoinBehavior)joinBehaviorProperty.intValue != DualSenseManager.PlayerJoinBehavior.JoinPlayersManually)
    //        {
    ...
    //            {
    //                var joinActionProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_JoinAction));
    //                EditorGUILayout.PropertyField(joinActionProperty);
    //            }

    //            Player prefab.
    //            var playerPrefabProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_PlayerPrefab));
    ...
    //        Enabled - by - default.
    //        var allowJoiningProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_AllowJoining));
    ...
    //        Max player count.
    //       var maxPlayerCountProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_MaxPlayerCount));
    ...
    //        Split - screen toggle.
    //         var splitScreenProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_SplitScreen));
    ...
    //           var maintainAspectRatioProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_MaintainAspectRatioInSplitScreen));
    ...
    //        Fixed - number toggle.
    //         var fixedNumberProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_FixedNumberOfSplitScreens));
    ...
    //        Split - screen area.
    //         var splitScreenAreaProperty = serializedObject.FindProperty(nameof(DualSenseManager.m_SplitScreenRect));
