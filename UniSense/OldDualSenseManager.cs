...
//TODO: USB dualsense could possible trigger join action while in the pair queue. Differentaite between valid usb join and invalid ubs join by seeing if a user is attached to the device.
[DisallowMultipleComponent]
public class OldDualSenseManager : MonoBehaviour, IHandleMultiplayer
{
    ...
    public static OldDualSenseManager instance { get; private set; }
    #endregion
