...
namespace UniSense.Connections
{
	...
	#endregion
	public static class DeprecetedUniSenseConnectionHandler
	{
		...
		/// </summary>
		/// <param name="uniqueIdentifier"> Use <see cref="DeprecetedUniSenseConnectionHandler.GenerateUniqueIdentifier(GameObject, string)"/> to generate this unique identifier </param>
		...
		private static void CloseBTConnection(ref Controller controller)
		{
			...
			{
				DS5W_x64.freeDeviceContext(ref controller.devices.contextBT, true);
			}
			else
			{
				DS5W_x86.freeDeviceContext(ref controller.devices.contextBT, true);
			}
		}
